...
import tn.esprit.interfaces.Eservice;
...
public class EmailSender implements Eservice<User> {

    // Read the image file and convert it to a base64 encoded string
    // @Override
    public void sendEmail(String to, String descri, String subject) throws MessagingException {
